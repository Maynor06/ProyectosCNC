...
LIMIT_X = 500.0  # El ancho máximo real de tu área de dibujo
LIMIT_Y = 1150.0  # El alto máximo real de tu área de dibujo
...
def svg_to_gcode(svg_path: str, gcode_path: str, max_width=500, max_height=1000):
